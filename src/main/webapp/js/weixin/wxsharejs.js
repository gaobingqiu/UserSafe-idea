 ...
 **/
var appId = '';
if(typeof(_true_uid)=="undefined") { //真实uid
	var _wx_uid = '';
	var _is_true_uid = 0;
} else {
	var _wx_uid = _true_uid;
	var _is_true_uid = 1;
}
if(typeof(_share_debug)=="undefined") { //加入debug
	var _share_debug = false;
} else {
	var _share_debug = true;
}
var timestamp = '';
var nonceStr = '';
var signature = '';
$.ajax({
	...
	dataType: "json",
	data:{uid:_wx_uid,t_uid:_is_true_uid,url:window.location.href},
	async: false,
